...
ACLOCAL = ${SHELL} /home/static/throughput/wget_load/bin/wget_operation_limit/build-aux/missing --run aclocal-1.11
ALLOCA = 
ALLOCA_H = alloca.h
AMTAR = $${TAR-tar}
...
ARFLAGS = cru
ASM_SYMBOL_PREFIX = ""
AUTOCONF = ${SHELL} /home/static/throughput/wget_load/bin/wget_operation_limit/build-aux/missing --run autoconf
AUTOHEADER = ${SHELL} /home/static/throughput/wget_load/bin/wget_operation_limit/build-aux/missing --run autoheader
AUTOMAKE = ${SHELL} /home/static/throughput/wget_load/bin/wget_operation_limit/build-aux/missing --run automake-1.11
AWK = gawk
BITSIZEOF_PTRDIFF_T = 
...
LIBOBJS =  ${LIBOBJDIR}ftp-opie$U.o ${LIBOBJDIR}openssl$U.o ${LIBOBJDIR}http-ntlm$U.o
LIBPTH = 
LIBPTH_PREFIX = 
LIBS = -lssl -lcrypto -lz -ldl -lz -lz  -lidn -luuid -lpcre
LIBSOCKET = 
...
LTLIBOBJS =  ${LIBOBJDIR}ftp-opie$U.lo ${LIBOBJDIR}openssl$U.lo ${LIBOBJDIR}http-ntlm$U.lo
LTLIBPTH = 
LTLIBSSL = -lssl -lcrypto -lz
LTLIBTHREAD = 
MAKEINFO = ${SHELL} /home/static/throughput/wget_load/bin/wget_operation_limit/build-aux/missing --run makeinfo
MKDIR_P = /bin/mkdir -p
...
abs_builddir = /home/static/throughput/wget_load/bin/wget_operation_limit
abs_srcdir = /home/static/throughput/wget_load/bin/wget_operation_limit
abs_top_builddir = /home/static/throughput/wget_load/bin/wget_operation_limit
abs_top_srcdir = /home/static/throughput/wget_load/bin/wget_operation_limit
ac_ct_CC = gcc
am__include = include
am__leading_dot = .
am__quote = 
...
dvidir = ${docdir}
exec_prefix = ${prefix}
gl_LIBOBJS =  asnprintf.o fcntl.o futimens.o getopt.o getopt1.o getpass.o ioctl.o printf-args.o printf-parse.o strcasestr.o strerror.o strerror_r.o vasnprintf.o
gl_LTLIBOBJS =  asnprintf.lo fcntl.lo futimens.lo getopt.lo getopt1.lo getpass.lo ioctl.lo printf-args.lo printf-parse.lo strcasestr.lo strerror.lo strerror_r.lo vasnprintf.lo
gltests_LIBOBJS = 
gltests_LTLIBOBJS = 
...
install_sh = ${SHELL} /home/static/throughput/wget_load/bin/wget_operation_limit/build-aux/install-sh
